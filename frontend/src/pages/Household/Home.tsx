          ...
          <Card className="w-full max-w-4xl p-2 shadow-xl border-none">
            <form
              ...
              <div className="flex-1 relative">
                ...
                <select className="w-full h-12 pl-10 pr-4 rounded-md border border-input bg-background text-foreground focus:outline-none focus:ring-2 focus:ring-ring">
        ...
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-end mb-10">
            <div>
              ...
              <p className="text-muted-foreground">
                Highly recommended helpers in your area
              </p>
            </div>
            <Link to="/browse">
